                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i>{{ $blog->author }}</a>
                                </li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i><time
                                        datetime="2020-01-01">{{ $blog->created_at->format('d F Y') }}</time></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="entry-footer">
                            ...
                            <ul class="cats">
                                <li><a
                                        href="{{ route('blog.showByCategory', ['category' => $blog->category]) }}">{{ $blog->category }}</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="sidebar-item categories">
                            <ul>
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    <li><a href="{{ route('blog.showByCategory', ['category' => $category]) }}">{{ $category }}
